...
export const routes: Routes = [
  ...
  { path: 'admin/create-firm', component: CreateOrganizationComponent, canActivate: [AuthGuard] },
  { path: 'admin/edit-firm/:id', component: CreateOrganizationComponent, canActivate: [AuthGuard] },
